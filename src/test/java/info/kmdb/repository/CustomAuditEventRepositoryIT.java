package info.kmdb.repository;

import info.kmdb.JhipsterReactNativeApp;
import info.kmdb.config.Constants;
import info.kmdb.config.audit.AuditEventConverter;
import info.kmdb.domain.PersistentAuditEvent;
...
import static info.kmdb.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
